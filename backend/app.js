...
app.post("/upload", upload.single("file"), async (req, res) => {
  try {
    ...
    identificationRequest.append(
      "organs",
      req.body.organ?.toLowerCase() || "auto"
    );
    identificationRequest.append("images", fileBlob, req.file.originalname);
    const identificationResponse = await axios.post(
      `https://my-api.plantnet.org/v2/identify/all?include-related-images=true&no-reject=false&lang=en&api-key=2b10y4v0e005Y3nzwf9zYpOsO`,
